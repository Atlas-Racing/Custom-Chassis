...
class PurePursuitNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("single_side_offset_multiplier", 2.5)
        self.declare_parameter("path_save_file", "")
        ...
        if self.state == 0: # START_ZONE
            ...
            if len(close_orange_cones) >= 2:
                ...
                if self.lap_count >= self.target_laps:
                    ...
                    map_path = os.path.join(os.getcwd(), "docs", "new_map1")
                    try:
                    ...
                    # Save Path
                    path_file = self.get_parameter("path_save_file").value or \
                        os.path.join(os.getcwd(), "docs", "new_map1.csv")
                    try:
